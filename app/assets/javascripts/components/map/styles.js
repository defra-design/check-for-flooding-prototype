...
const desc = `
  This chart shows river levels over the last 5 days.
  The current level is 0.28 metres and is falling.
  Levels are within the normal range of 0.24 to 0.36 metres.
`;

document.getElementById('chart-desc').textContent = desc;
